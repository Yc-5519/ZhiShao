...
TARGET_LOCK_REACQUIRE_SECONDS = _env_float("ZHISHAO_TARGET_LOCK_REACQUIRE_SECONDS", 8.0)
...
WEB_SKELETON_JPEG_QUALITY = _env_int("ZHISHAO_WEB_SKELETON_JPEG_QUALITY", 52)
WEB_RAW_JPEG_QUALITY = _env_int("ZHISHAO_WEB_RAW_JPEG_QUALITY", 48)
VISION_INFERENCE_MAX_FPS = _env_float("ZHISHAO_VISION_INFERENCE_MAX_FPS", 10.0)
