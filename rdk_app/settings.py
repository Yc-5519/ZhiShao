...
PTZ_DEADZONE_X = _env_int("ZHISHAO_PTZ_DEADZONE_X", 90)
PTZ_DEADZONE_Y = _env_int("ZHISHAO_PTZ_DEADZONE_Y", 75)
...
PTZ_MAX_STEP_X = _env_float("ZHISHAO_PTZ_MAX_STEP_X", 6.0)
PTZ_MAX_STEP_Y = _env_float("ZHISHAO_PTZ_MAX_STEP_Y", 4.0)
...
TARGET_LOCK_REACQUIRE_SECONDS = _env_float("ZHISHAO_TARGET_LOCK_REACQUIRE_SECONDS", 18.0)
...
# =========================================================================
WEB_VIDEO_FRAME_INTERVAL_SECONDS = _env_float("ZHISHAO_WEB_VIDEO_FRAME_INTERVAL_SECONDS", 0.28)
WEB_SKELETON_JPEG_QUALITY = _env_int("ZHISHAO_WEB_SKELETON_JPEG_QUALITY", 44)
WEB_RAW_JPEG_QUALITY = _env_int("ZHISHAO_WEB_RAW_JPEG_QUALITY", 40)
WEB_SNAPSHOT_REFRESH_SECONDS = _env_float("ZHISHAO_WEB_SNAPSHOT_REFRESH_SECONDS", 1.1)
VISION_INFERENCE_MAX_FPS = _env_float("ZHISHAO_VISION_INFERENCE_MAX_FPS", 8.0)
